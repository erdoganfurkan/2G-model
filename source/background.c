...
int background_derivs(
  ...
  dy[pba->index_bi_rs] = 1./sqrt(3.*(1.+3.*pvecback[pba->index_bg_rho_b]*pow(pba->lambda_G_rad,2)/4./pvecback[pba->index_bg_rho_g]/pow(pba->lambda_G_mat,2)))*sqrt(1.-pba->K*y[pba->index_bi_rs]*y[pba->index_bi_rs]); // TBC: curvature correction
