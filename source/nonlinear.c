...
int nonlinear_hmcode(
  ...
  rho_crit_today_in_msun_mpc3 = 3.*pow(1.e5*pba->h, 2)/8./_PI_/_G_/pba->lambda_G_mat_z_0/pba->lambda_G_mat_z_0*_Mpc_over_m_/_M_SUN_; /* We can neglect radiation part, radiation being << than matter today */
